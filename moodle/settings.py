...
EMAIL_HOST_USER = '' #Email to send messesges
EMAIL_HOST_PASSWORD = '' #Password to allow django accessing the email
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
CKEDITOR_5_CONFIGS = {
    ...
    'announcement': {
        ...
        'toolbar': ['heading', '|', 'outdent', 'indent', '|', 'bold', 'italic', 'underline', 'strikethrough', '|',
                    'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor', 'removeFormat', '|', 'link', 
